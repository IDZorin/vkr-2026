# Explained Metrics and Checks: formula_ir_drafting
...
## Checks
### `avoid_over_reification`
- what it checks: Semantic shape policy check.
- what is wrong when it fails: The IR shape does not match the local semantic burden.
- likely action: Redraft around focus term, carrier, and explicit support structure.
...
### `keep_qualifications_outside_focus_name`
- what it checks: Semantic shape policy check.
- what is wrong when it fails: The IR shape does not match the local semantic burden.
- likely action: Redraft around focus term, carrier, and explicit support structure.
