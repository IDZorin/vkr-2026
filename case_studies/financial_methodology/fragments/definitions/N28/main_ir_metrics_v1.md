# Translation Metrics v1 - N28

- generated_at: `2026-05-10T20:09:44.596642+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N28\N28_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    ...
    "documentpart",
    "introductionsection",
    "solactive_meaning_defined_in_introduction",
    "solactiveterm",
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9906134605407715,
  "source_implies_normalized_entailment": 0.9906134605407715,
  "source_vs_normalized_contradiction_score": 0.0015478061977773905
}
```
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.40228357911109924,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.40228357911109924,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.46900278329849243,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.13285602629184723,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04469817545678881,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.014761780699094137,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.052111420366499156,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.017879270182715522,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.0059047122796376545,
...
```json
{
  ...
  "render_back_text": "defined term is a type. solactive term is a distinguished entity. introduction section is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7685223817825317,
  "render_bertscore_recall_to_normalized": 0.8441593647003174,
  "render_bertscore_f1_to_normalized": 0.8045671582221985,
  "render_bertscore_precision_to_source": 0.7685223817825317,
  "render_bertscore_recall_to_source": 0.8441593647003174,
  "render_bertscore_f1_to_source": 0.8045671582221985,
  "render_nli_ir_implies_text": 0.9380055665969849,
  "render_nli_text_implies_ir": 0.26571205258369446,
  "render_nli_ir_implies_source": 0.9380055665969849,
  "render_nli_source_implies_ir": 0.26571205258369446,
  "render_nli_render_to_normalized": {
    "entailment": 0.9380055665969849,
    "neutral": 0.027458155527710915,
    "contradiction": 0.03453633189201355
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.26571205258369446,
    "neutral": 0.7035472989082336,
    "contradiction": 0.03074067272245884
  },
  ...
  "render_contradiction_score": 0.03453633189201355
}
```
