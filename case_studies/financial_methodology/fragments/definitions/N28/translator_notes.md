# Definition N28 Translator Notes
...
Decision: represent `"Solactive" shall have the meaning as defined in Section "Introduction"` as a cross-reference definition.
...
- Do not invent the substantive meaning of "Solactive" locally.
