...
### `unused_declaration` / `RebalanceDay`

- severity: `soft`
- line: `1`
- reason: Declaration is not referenced by any assertion body, deontic field, or another declaration signature.
- raw: `sort RebalanceDay extends Day`

### `unused_declaration` / `ScheduledRebalanceDay`

- severity: `soft`
- line: `2`
- reason: Declaration is not referenced by any assertion body, deontic field, or another declaration signature.
- raw: `sort ScheduledRebalanceDay extends Day`
