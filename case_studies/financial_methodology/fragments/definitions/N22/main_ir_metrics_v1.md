# Translation Metrics v1 - N22

- generated_at: `2026-05-10T19:59:52.351728+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N22\N22_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "definedterm",
    "documentpart",
    "index_universe_requirements_meaning_defined_in_section_2_1",
    "indexuniverserequirementsterm",
    "section2_1",
...
```json
{
  ...
  "formula_repeat_overuse_examples": [
    ...
    {
      "token": "indexuniverserequirementsterm",
      "current_count": 2,
      "baseline_count": 0,
      "delta": 2
    },
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9899129867553711,
  "source_implies_normalized_entailment": 0.9899129867553711,
  "source_vs_normalized_contradiction_score": 0.003259381279349327
}
```
...
```json
{
  ...
  "top_glued_identifiers": [
    ...
    {
      "identifier": "IndexUniverseRequirementsTerm",
      "raw_piece_count": 4,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4046437740325928,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4046437740325928,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.06743507832288742,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.10000897198915482,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04259408147711503,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.010527260209384718,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.007098429297146045,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.017593207566634468,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.004348216173441514,
...
```json
{
  ...
  "render_back_text": "defined term is a type. index universe requirements term is a distinguished entity. section2 1 is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.780666708946228,
  "render_bertscore_recall_to_normalized": 0.8400869965553284,
  "render_bertscore_f1_to_normalized": 0.8092875480651855,
  "render_bertscore_precision_to_source": 0.780666708946228,
  "render_bertscore_recall_to_source": 0.8400869965553284,
  "render_bertscore_f1_to_source": 0.8092875480651855,
  "render_nli_ir_implies_text": 0.13487015664577484,
  "render_nli_text_implies_ir": 0.20001794397830963,
  "render_nli_ir_implies_source": 0.13487015664577484,
  "render_nli_source_implies_ir": 0.20001794397830963,
  "render_nli_render_to_normalized": {
    "entailment": 0.13487015664577484,
    "neutral": 0.08673053234815598,
    "contradiction": 0.7783992886543274
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.20001794397830963,
    "neutral": 0.7421156764030457,
    "contradiction": 0.057866357266902924
  },
  ...
  "render_contradiction_score": 0.7783992886543274
}
```
