# Translation Metrics v1 - N20

- generated_at: `2026-05-10T19:57:05.744338+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N20\N20_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "definedterm",
    "documentpart",
    "index_component_requirements_meaning_defined_in_section_2_2",
    "indexcomponentrequirementsterm",
    "section2_2",
...
```json
{
  ...
  "formula_content_token_mass": 27,
  "full_surface_content_token_count": 35,
  "full_surface_content_token_mass": 54,
  ...
  "formula_content_token_multiset_precision": 0.2962962962962963,
  ...
  "formula_repeat_overuse_examples": [
    ...
    {
      "token": "indexcomponentrequirementsterm",
      "current_count": 2,
      "baseline_count": 0,
      "delta": 2
    },
  ...
  "full_surface_content_token_multiset_precision": 0.14814814814814814,
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9896315932273865,
  "source_implies_normalized_entailment": 0.9896315932273865,
  "source_vs_normalized_contradiction_score": 0.0035521360114216805
}
```
...
```json
{
  ...
  "mean_identifier_piece_count_raw": 3.4,
  "mean_identifier_piece_count_content": 3,
  "identifier_glue_excess_mass_raw": 5,
  "identifier_glue_excess_mass_content": 6,
  "identifier_glue_excess_rate_raw": 1.0,
  "identifier_glue_excess_rate_content": 1.2,
  "source_grounded_content_piece_ratio_mean": 0.4166666666666667,
  "advisory_grounded_content_piece_ratio_mean": 0.4166666666666667,
  ...
  "top_glued_identifiers": [
    ...
    {
      "identifier": "IndexComponentRequirementsTerm",
      "raw_piece_count": 4,
...
```json
{
  ...
  "formula_repeat_overuse_rate": 2.375,
  "full_surface_repeat_overuse_rate": 5.75,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.40770089626312256,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.40770089626312256,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.48620688915252686,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.08743441104888916,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.0429158838171708,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.009203622215672544,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.05117967254237125,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.01772612592448359,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.003801496132560398,
...
```json
{
  ...
  "render_back_text": "defined term is a type. index component requirements term is a distinguished entity. section2 2 is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7889592051506042,
  "render_bertscore_recall_to_normalized": 0.84367835521698,
  "render_bertscore_f1_to_normalized": 0.8154017925262451,
  "render_bertscore_precision_to_source": 0.7889592051506042,
  "render_bertscore_recall_to_source": 0.84367835521698,
  "render_bertscore_f1_to_source": 0.8154017925262451,
  "render_nli_ir_implies_text": 0.9724137783050537,
  "render_nli_text_implies_ir": 0.17486882209777832,
  "render_nli_ir_implies_source": 0.9724137783050537,
  "render_nli_source_implies_ir": 0.17486882209777832,
  "render_nli_render_to_normalized": {
    "entailment": 0.9724137783050537,
    "neutral": 0.020459242165088654,
    "contradiction": 0.007127053570002317
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.17486882209777832,
    "neutral": 0.7904856204986572,
    "contradiction": 0.034645576030015945
  },
  ...
  "render_contradiction_score": 0.034645576030015945
}
```
