...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "benchmark_regulation_meaning_defined_in_introduction",
    "benchmarkregulationterm",
    "definedterm",
    "documentpart",
    "introductionsection",
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9901296496391296,
  "source_implies_normalized_entailment": 0.9901296496391296,
  "source_vs_normalized_contradiction_score": 0.0024537923745810986
}
```
...
```json
{
  ...
  "top_glued_identifiers": [
    ...
    {
      "identifier": "BenchmarkRegulationTerm",
      "raw_piece_count": 3,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4065476953983307,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4065476953983307,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.4449961483478546,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.17057204246520996,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04517196615537008,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.018952449162801106,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.04944401648309496,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.01806878646214803,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.007580979665120443,
...
```json
{
  ...
  "render_back_text": "defined term is a type. benchmark regulation term is a distinguished entity. introduction section is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7784929275512695,
  "render_bertscore_recall_to_normalized": 0.8509169816970825,
  "render_bertscore_f1_to_normalized": 0.8130953907966614,
  "render_bertscore_precision_to_source": 0.7784929275512695,
  "render_bertscore_recall_to_source": 0.8509169816970825,
  "render_bertscore_f1_to_source": 0.8130953907966614,
  "render_nli_ir_implies_text": 0.8899922966957092,
  "render_nli_text_implies_ir": 0.3411440849304199,
  "render_nli_ir_implies_source": 0.8899922966957092,
  "render_nli_source_implies_ir": 0.3411440849304199,
  "render_nli_render_to_normalized": {
    "entailment": 0.8899922966957092,
    "neutral": 0.035906825214624405,
    "contradiction": 0.07410087436437607
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.3411440849304199,
    "neutral": 0.6161761283874512,
    "contradiction": 0.0426797978579998
  },
  ...
  "render_contradiction_score": 0.07410087436437607
}
```
