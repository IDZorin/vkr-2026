# Definition N16 Translator Notes
...
Decision: represent `"Guideline" shall have the meaning as defined in Section "Introduction"` as a cross-reference definition.
...
- Do not invent the substantive meaning of "Guideline" locally.
