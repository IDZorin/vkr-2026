# Translation Metrics v1 - N32

- generated_at: `2026-05-10T20:17:30.501090+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N32\N32_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    ...
    "wm_refinitiv_rate_meaning_defined_in_section_1_4",
    "wmrefinitivrateterm"
  ],
...
```json
{
  ...
  "full_surface_content_token_jaccard": 0.08823529411764706,
  "formula_content_token_multiset_recall": 1.0,
  "formula_content_token_multiset_precision": 0.2692307692307692,
  ...
  "full_surface_content_token_multiset_precision": 0.1320754716981132,
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9902598261833191,
  "source_implies_normalized_entailment": 0.9902598261833191,
  "source_vs_normalized_contradiction_score": 0.0027789156883955
}
```
...
```json
{
  ...
  "source_grounded_content_piece_ratio_mean": 0.3333333333333333,
  "advisory_grounded_content_piece_ratio_mean": 0.3333333333333333,
  ...
  "top_glued_identifiers": [
    ...
    {
      "identifier": "WMRefinitivRateTerm",
      "raw_piece_count": 3,
...
```json
{
  ...
  "full_surface_repeat_overuse_rate": 6.571428571428571,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4002695381641388,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4002695381641388,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.17829248309135437,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.13058023154735565,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.042133635596225134,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.013745287531300596,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.018767629799089934,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.01740302339844082,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.005677401371624159,
...
```json
{
  ...
  "render_back_text": "defined term is a type. wmrefinitiv rate term is a distinguished entity. section1 4 is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7771084308624268,
  "render_bertscore_recall_to_normalized": 0.8254265189170837,
  "render_bertscore_f1_to_normalized": 0.8005390763282776,
  "render_bertscore_precision_to_source": 0.7771084308624268,
  "render_bertscore_recall_to_source": 0.8254265189170837,
  "render_bertscore_f1_to_source": 0.8005390763282776,
  "render_nli_ir_implies_text": 0.35658496618270874,
  "render_nli_text_implies_ir": 0.2611604630947113,
  "render_nli_ir_implies_source": 0.35658496618270874,
  "render_nli_source_implies_ir": 0.2611604630947113,
  "render_nli_render_to_normalized": {
    "entailment": 0.35658496618270874,
    "neutral": 0.09294013679027557,
    "contradiction": 0.5504749417304993
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.2611604630947113,
    "neutral": 0.6974362730979919,
    "contradiction": 0.04140326753258705
  },
  ...
  "render_contradiction_score": 0.5504749417304993
}
```
