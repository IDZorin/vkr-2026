# Translation Metrics v1 - N25

- generated_at: `2026-05-10T20:07:15.243874+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N25\N25_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "definedterm",
    "documentpart",
    "oversight_committee_meaning_defined_in_section_5_5",
    "oversightcommitteeterm",
    "section5_5",
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9905133247375488,
  "source_implies_normalized_entailment": 0.9905133247375488,
  "source_vs_normalized_contradiction_score": 0.0029867482371628284
}
```
...
```json
{
  ...
  "source_grounded_content_piece_ratio_mean": 0.4,
  "advisory_grounded_content_piece_ratio_mean": 0.4,
  ...
  "top_glued_identifiers": [
    ...
    {
      "identifier": "OversightCommitteeTerm",
      "raw_piece_count": 3,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4055913984775543,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4055913984775543,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.4837011694908142,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.16862662136554718,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04269383141868993,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.0177501706700576,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.05091591257798044,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.017634408629458885,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.00733159223328466,
...
```json
{
  ...
  "render_back_text": "defined term is a type. oversight committee term is a distinguished entity. section5 5 is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7785845994949341,
  "render_bertscore_recall_to_normalized": 0.8466299772262573,
  "render_bertscore_f1_to_normalized": 0.8111827969551086,
  "render_bertscore_precision_to_source": 0.7785845994949341,
  "render_bertscore_recall_to_source": 0.8466299772262573,
  "render_bertscore_f1_to_source": 0.8111827969551086,
  "render_nli_ir_implies_text": 0.9674023389816284,
  "render_nli_text_implies_ir": 0.33725324273109436,
  "render_nli_ir_implies_source": 0.9674023389816284,
  "render_nli_source_implies_ir": 0.33725324273109436,
  "render_nli_render_to_normalized": {
    "entailment": 0.9674023389816284,
    "neutral": 0.02061685547232628,
    "contradiction": 0.01198082696646452
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.33725324273109436,
    "neutral": 0.6316055059432983,
    "contradiction": 0.03114127553999424
  },
  ...
  "render_contradiction_score": 0.03114127553999424
}
```
