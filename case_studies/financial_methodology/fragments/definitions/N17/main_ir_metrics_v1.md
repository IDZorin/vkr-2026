# Translation Metrics v1 - N17

- generated_at: `2026-05-10T20:29:04.592967+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N17\N17_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "definedterm",
    "documentpart",
    "index_meaning_defined_in_introduction",
    "indexterm",
    "introductionsection",
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9880170822143555,
  "source_implies_normalized_entailment": 0.9880170822143555,
  "source_vs_normalized_contradiction_score": 0.0017506539588794112
}
```
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4032934606075287,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4032934606075287,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.4617767035961151,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.123324915766716,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04481038451194763,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.013702768418524,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.051308522621790566,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.017924153804779054,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.0054811073674096,
...
```json
{
  ...
  "render_back_text": "defined term is a type. index term is a distinguished entity. introduction section is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7764304280281067,
  "render_bertscore_recall_to_normalized": 0.839180588722229,
  "render_bertscore_f1_to_normalized": 0.8065869212150574,
  "render_bertscore_precision_to_source": 0.7764304280281067,
  "render_bertscore_recall_to_source": 0.839180588722229,
  "render_bertscore_f1_to_source": 0.8065869212150574,
  "render_nli_ir_implies_text": 0.9235534071922302,
  "render_nli_text_implies_ir": 0.246649831533432,
  "render_nli_ir_implies_source": 0.9235534071922302,
  "render_nli_source_implies_ir": 0.246649831533432,
  "render_nli_render_to_normalized": {
    "entailment": 0.9235534071922302,
    "neutral": 0.03501121699810028,
    "contradiction": 0.04143539071083069
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.246649831533432,
    "neutral": 0.7214363813400269,
    "contradiction": 0.031913820654153824
  },
  ...
  "render_contradiction_score": 0.04143539071083069
}
```
