# Definition N03 Translator Notes
...
Decision: represent `"BMR" shall have the meaning as defined in Section "Introduction"` as a cross-reference definition.
...
- Do not invent the substantive meaning of "BMR" locally.
