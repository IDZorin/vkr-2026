# Translation Metrics v1 - N03

- generated_at: `2026-05-10T20:28:34.514956+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N03\N03_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "bmr_meaning_defined_in_introduction",
    "bmrterm",
    "definedterm",
    "documentpart",
    "introductionsection",
...
```json
{
  ...
  "formula_content_token_mass": 24,
  "full_surface_content_token_count": 33,
  "full_surface_content_token_mass": 51,
  ...
  "full_surface_content_token_multiset_precision": 0.11764705882352941,
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9910475611686707,
  "source_implies_normalized_entailment": 0.9910475611686707,
  "source_vs_normalized_contradiction_score": 0.001413521240465343
}
```
...
```json
{
  ...
  "mean_identifier_piece_count_raw": 2.8,
  ...
  "source_grounded_content_piece_ratio_mean": 0.4666666666666667,
  "advisory_grounded_content_piece_ratio_mean": 0.4666666666666667,
...
```json
{
  ...
  "full_surface_repeat_overuse_rate": 7.5,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.40272191166877747,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.40272191166877747,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.44892802834510803,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.14428918063640594,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.044746879074308604,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.01603213118182288,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.04988089203834534,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.017898751629723444,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.006412852472729153,
...
```json
{
  ...
  "render_back_text": "defined term is a type. bmrterm is a distinguished entity. introduction section is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7709401845932007,
  "render_bertscore_recall_to_normalized": 0.8431805372238159,
  "render_bertscore_f1_to_normalized": 0.8054438233375549,
  "render_bertscore_precision_to_source": 0.7709401845932007,
  "render_bertscore_recall_to_source": 0.8431805372238159,
  "render_bertscore_f1_to_source": 0.8054438233375549,
  "render_nli_ir_implies_text": 0.8978560566902161,
  "render_nli_text_implies_ir": 0.2885783612728119,
  "render_nli_ir_implies_source": 0.8978560566902161,
  "render_nli_source_implies_ir": 0.2885783612728119,
  "render_nli_render_to_normalized": {
    "entailment": 0.8978560566902161,
    "neutral": 0.04788544774055481,
    "contradiction": 0.05425860360264778
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.2885783612728119,
    "neutral": 0.6757383942604065,
    "contradiction": 0.035683322697877884
  },
  ...
  "render_contradiction_score": 0.05425860360264778
}
```
