# Translation Metrics v1 - N04

- generated_at: `2026-05-10T19:23:12.384166+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N04\N04_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9891486763954163,
  "source_implies_normalized_entailment": 0.9891486763954163,
  "source_vs_normalized_contradiction_score": 0.004288617521524429
}
```
...
```json
{
  ...
  "top_glued_identifiers": [
    {
      "identifier": "business_day_definition",
      "raw_piece_count": 3,
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.3687651753425598,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.3687651753425598,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.279542475938797,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.42615261673927307,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.06704821369864723,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.07748229395259511,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.050825904716144905,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.019408693439082095,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.02242908509154069,
...
```json
{
  ...
  "render_back_text": "constraint business day definition states that for every d of type day, business day for d if and only if (weekday of for d equals monday, weekday of for d equals tuesday, weekday of for d equals wednesday, weekday of for d equals thursday, or weekday of for d equals friday). business day holds between day.",
  "render_bertscore_precision_to_normalized": 0.6901859045028687,
  "render_bertscore_recall_to_normalized": 0.7918487191200256,
  "render_bertscore_f1_to_normalized": 0.7375303506851196,
  "render_bertscore_precision_to_source": 0.6901859045028687,
  "render_bertscore_recall_to_source": 0.7918487191200256,
  "render_bertscore_f1_to_source": 0.7375303506851196,
  "render_nli_ir_implies_text": 0.559084951877594,
  "render_nli_text_implies_ir": 0.8523052334785461,
  "render_nli_ir_implies_source": 0.559084951877594,
  "render_nli_source_implies_ir": 0.8523052334785461,
  "render_nli_render_to_normalized": {
    "entailment": 0.559084951877594,
    "neutral": 0.10683988034725189,
    "contradiction": 0.3340752124786377
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.8523052334785461,
    "neutral": 0.09167064726352692,
    "contradiction": 0.056024130433797836
  },
  ...
  "render_contradiction_score": 0.3340752124786377
}
```
