...
- repair: Inspect relevant artifacts and apply module-specific repair rules.
- evidence:
  - `assertion_complexity.top_complex_assertions` → business_day_definition
...
- evidence:
  - `identifier_glue.top_glued_identifiers` → {'identifier': 'business_day_definition', 'raw_piece_count': 3, 'content_piece_c; {'identifier': 'business_day', 'raw_piece_count': 2, 'content_piece_count': 2, '; {'identifier': 'Day', 'raw_piece_count': 1, 'content_piece_count': 1, 'raw_piece (+7 more)
  - `identifier_glue.lowest_source_grounded_identifiers` → {'identifier': 'business_day_definition', 'raw_piece_count': 3, 'content_piece_c; {'identifier': 'business_day', 'raw_piece_count': 2, 'content_piece_count': 2, '
...
- evidence:
  - `grounding.new_formula_content_tokens_vs_text_only` → business_day; business_day_definition; thursday (+3 more)
  - `grounding.new_full_surface_content_tokens_vs_text_only` → a4v3; business_day; business_day_definition (+23 more)
  - `lexical_coverage.formula_repeat_overuse_examples` → {'token': 'weekdayof', 'current_count': 5, 'baseline_count': 0, 'delta': 5}; {'token': 'business', 'current_count': 3, 'baseline_count': 1, 'delta': 2}; {'token': 'definition', 'current_count': 1, 'baseline_count': 0, 'delta': 1} (+3 more)
...
- repair: Inspect relevant artifacts and apply module-specific repair rules.
- evidence:
  - `render_back.render_back_text` → A business day is any day that falls on Monday, Tuesday, Wednesday, Thursday, or Friday.
  - `render_back.render_nli_text_implies_ir` → 0.12524309754371643
  - `render_back.render_nli_ir_implies_text` → 0.8642303943634033
  - `render_back.render_contradiction_score` → 0.40581420063972473
