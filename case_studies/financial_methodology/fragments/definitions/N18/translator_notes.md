# Definition N18 Translator Notes
...
Decision: represent `"Index Administrator" shall have the meaning as defined in Section "Introduction"` as a cross-reference definition.
...
- Do not invent the substantive meaning of "Index Administrator" locally.
