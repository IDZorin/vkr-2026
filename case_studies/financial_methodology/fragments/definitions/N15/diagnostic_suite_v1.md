...
- repair: Inspect relevant artifacts and apply module-specific repair rules.
- evidence:
  - `assertion_complexity.top_complex_assertions` → gbs_index_component_definition
...
- evidence:
  - `identifier_glue.top_glued_identifiers` → {'identifier': 'GbsIndexSpecifiedInSection2_1', 'raw_piece_count': 6, 'content_p; {'identifier': 'gbs_index_specified_in_section', 'raw_piece_count': 5, 'content_; {'identifier': 'security_reflected_in_gbs_index', 'raw_piece_count': 5, 'content (+7 more)
  - `identifier_glue.lowest_source_grounded_identifiers` → {'identifier': 'DocumentPart', 'raw_piece_count': 2, 'content_piece_count': 2, '; {'identifier': 'gbs_index_component_definition', 'raw_piece_count': 4, 'content_; {'identifier': 'GbsIndexSpecifiedInSection2_1', 'raw_piece_count': 6, 'content_p (+4 more)
...
- value: **2.5**  (from `identifier_glue.mean_identifier_piece_count_content`)
- meaning: Semantics may be packed into names; report the exact identifier, pieces, grounding ratios, and source links.
- repair: Split long identifiers into anchored functions/relations/ontology links.
- evidence:
  - `identifier_glue.top_glued_identifiers` → {'identifier': 'GbsIndexSpecifiedInSection2_1', 'raw_piece_count': 6, 'content_p; {'identifier': 'gbs_index_specified_in_section', 'raw_piece_count': 5, 'content_; {'identifier': 'security_reflected_in_gbs_index', 'raw_piece_count': 5, 'content (+7 more)
...
- value: **3.1**  (from `identifier_glue.mean_identifier_piece_count_raw`)
- meaning: Semantics may be packed into names; report the exact identifier, pieces, grounding ratios, and source links.
- repair: Split long identifiers into anchored functions/relations/ontology links.
- evidence:
  - `identifier_glue.top_glued_identifiers` → {'identifier': 'GbsIndexSpecifiedInSection2_1', 'raw_piece_count': 6, 'content_p; {'identifier': 'gbs_index_specified_in_section', 'raw_piece_count': 5, 'content_; {'identifier': 'security_reflected_in_gbs_index', 'raw_piece_count': 5, 'content (+7 more)
...
- evidence:
  - `grounding.new_formula_content_tokens_vs_text_only` → documentpart; financialinstrument; gbs_index_component (+7 more)
  - `grounding.new_full_surface_content_tokens_vs_text_only` → a4v3; canonical; computation (+26 more)
  - `lexical_coverage.formula_repeat_overuse_examples` → {'token': 'index', 'current_count': 8, 'baseline_count': 2, 'delta': 6}; {'token': 'security', 'current_count': 6, 'baseline_count': 1, 'delta': 5}; {'token': 'gbsindex', 'current_count': 5, 'baseline_count': 0, 'delta': 5} (+9 more)
...
- value: **34**  (from `grounding.new_full_surface_token_count_vs_text_only`)
- meaning: Target contains unsupported or excessive content; report the exact new/ungrounded/overused token or symbol list.
- repair: Remove unsupported content, rename symbols, or add explicit prelude/ontology/user-hint provenance.
- evidence:
  - `grounding.new_formula_content_tokens_vs_text_only` → documentpart; financialinstrument; gbs_index_component (+7 more)
