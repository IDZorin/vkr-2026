# Translation Metrics v1 - N24

- generated_at: `2026-05-10T20:04:29.276382+02:00`
- artifact_path: `D:\OneDrive\Documents\Study\MIPT\VKR\research_experiments\2026-02_pipeline\case_studies\financial_methodology\definitions\N24\N24_manual_section_workspace_artifact_current_v1.json`
...
```json
{
  ...
  "new_formula_content_tokens_vs_text_only": [
    "definedterm",
    "documentpart",
    "live_date_meaning_defined_in_section_1_3",
    "livedateterm",
    "section1_3",
...
```json
{
  ...
  "full_surface_content_token_jaccard": 0.06060606060606061,
...
```json
{
  ...
  "normalized_implies_source_entailment": 0.9720085859298706,
  "source_implies_normalized_entailment": 0.9720085859298706,
  "source_vs_normalized_contradiction_score": 0.019237786531448364
}
```
...
```json
{
  "render_bertscore_f1_to_normalized_per_parameter_slot_mass": 0.4010879397392273,
  "render_bertscore_f1_to_source_per_parameter_slot_mass": 0.4010879397392273,
  "render_nli_ir_implies_text_per_parameter_slot_mass": 0.013482160866260529,
  "render_nli_text_implies_ir_per_parameter_slot_mass": 0.084560826420784,
  "render_bertscore_f1_to_normalized_per_formula_repeat_overuse_mass": 0.04221978313044498,
  "render_nli_text_implies_ir_per_formula_repeat_overuse_mass": 0.00890113962324042,
  "render_nli_ir_implies_text_per_formula_repeat_overuse_mass": 0.001419174828027424,
  "render_bertscore_f1_to_normalized_per_full_surface_repeat_overuse_mass": 0.01743860607561858,
  "render_nli_text_implies_ir_per_full_surface_repeat_overuse_mass": 0.0036765576704688692,
...
```json
{
  ...
  "render_back_text": "defined term is a type. live date term is a distinguished entity. section1 3 is a distinguished entity. term shall have meaning defined in section holds between defined term and document part.",
  "render_bertscore_precision_to_normalized": 0.7709461450576782,
  "render_bertscore_recall_to_normalized": 0.8360427021980286,
  "render_bertscore_f1_to_normalized": 0.8021758794784546,
  "render_bertscore_precision_to_source": 0.7709461450576782,
  "render_bertscore_recall_to_source": 0.8360427021980286,
  "render_bertscore_f1_to_source": 0.8021758794784546,
  "render_nli_ir_implies_text": 0.026964321732521057,
  "render_nli_text_implies_ir": 0.169121652841568,
  "render_nli_ir_implies_source": 0.026964321732521057,
  "render_nli_source_implies_ir": 0.169121652841568,
  "render_nli_render_to_normalized": {
    "entailment": 0.026964321732521057,
    "neutral": 0.03446298837661743,
    "contradiction": 0.9385727047920227
  },
  "render_nli_normalized_to_render": {
    "entailment": 0.169121652841568,
    "neutral": 0.7156782746315002,
    "contradiction": 0.11520013958215714
  },
  ...
  "render_contradiction_score": 0.9385727047920227
}
```
