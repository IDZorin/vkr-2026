# A4V3 Semantic Lint: section_4_6

- total_findings: `1`
- strong/soft/style/advisory: `0` / `1` / `0` / `0`
- unused rel/fun: `0`
- arity > 5 hard findings: `0`
- arity > 2 without role explanation: `1`
...
- contract classes: `{"role_contract": 1}`

## Findings

### `relation_or_function_arity_gt_2_without_role_explanation` / `effort_goal`
...
- raw: `rel effort_goal : Effort, Index, IndexEffortGoal`
