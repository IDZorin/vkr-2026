...
(assert (! (and (calculation_time_of_closing_level_of_index CloseOfBusiness TheIndex) (outlined_in_section CloseOfBusiness Section1_4)) :named TEXT_close_of_business_definition))
(check-sat)
