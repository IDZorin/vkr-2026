...
; Probe N07__last_trading_price_used_when_closing_price_not_published__non_vacuity_guard__001: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((c FinancialInstrument) (d Day)) (and (IndexComponent c) (TradingDay d) (not (closing_price_available c d)))) :named PROBE_N07__last_trading_price_used_when_closing_price_not_published__non_vacuity_guard__001))
(check-sat)
(pop 1)
