...
; Probe N21__index_currency_definition__iff_rhs_witness__002: iff_rhs_witness
(check-sat)
(push 1)
(assert (! (exists ((i Index) (c Currency)) (exists ((spec IndexCurrencySpecification)) (and (specification_for_index spec i) (specification_currency spec c) (specification_column spec CurrencyColumn) (specification_table spec Section1_2IndexTable)))) :named PROBE_N21__index_currency_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
