...
; Probe N27__rebalance_day_change_disregarded_for_selection_day__non_vacuity_guard__001: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((sd Day) (rd Day)) (and (SelectionDay sd) (RebalanceDay rd) (selection_day_for_rebalance_day sd rd))) :named PROBE_N27__rebalance_day_change_disregarded_for_selection_day__non_vacuity_guard__001))
(check-sat)
(pop 1)
