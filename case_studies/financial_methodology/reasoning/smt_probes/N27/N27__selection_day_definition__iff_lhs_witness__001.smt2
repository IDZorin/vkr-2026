...
; Probe N27__selection_day_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((sd Day) (rd Day)) (and (SelectionDay sd) (RebalanceDay rd) (selection_day_for_rebalance_day sd rd))) :named PROBE_N27__selection_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
