...
; Probe N13__free_float_market_capitalization_calculated_as_multiplication_definition__existential_witness__002: existential_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s FinancialInstrument)) (and (SelectionDay d) (Security s) (exists ((vendor DataVendor)) (sourced_from_data_vendor (shares_outstanding_in_free_float d (share_class d s)) vendor)))) :named PROBE_N13__free_float_market_capitalization_calculated_as_multiplication_definition__existential_witness__002))
(check-sat)
(pop 1)
