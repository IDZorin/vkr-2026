...
; Probe N13__free_float_market_capitalization_calculated_as_multiplication_definition__non_vacuity_guard__001: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s FinancialInstrument)) (and (SelectionDay d) (Security s) (fulfills_index_component_requirements d s))) :named PROBE_N13__free_float_market_capitalization_calculated_as_multiplication_definition__non_vacuity_guard__001))
(check-sat)
(pop 1)
