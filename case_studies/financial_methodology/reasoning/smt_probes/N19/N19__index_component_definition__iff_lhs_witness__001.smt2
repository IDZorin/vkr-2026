...
; Probe N19__index_component_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((s FinancialInstrument)) (and (Security s) (index_component s TheIndex))) :named PROBE_N19__index_component_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
