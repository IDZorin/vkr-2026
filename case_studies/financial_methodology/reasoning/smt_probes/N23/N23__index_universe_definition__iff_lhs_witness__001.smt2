...
; Probe N23__index_universe_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((fi FinancialInstrument)) (financial_instrument_in_index_universe fi TheIndexUniverse)) :named PROBE_N23__index_universe_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
