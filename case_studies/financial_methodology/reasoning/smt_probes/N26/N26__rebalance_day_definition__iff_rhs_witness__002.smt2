...
; Probe N26__rebalance_day_definition__iff_rhs_witness__002: iff_rhs_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day)) (or (and (scheduled_rebalance_day d) (eligible_rebalance_day d)) (exists ((s Day)) (and (scheduled_rebalance_day s) (not (eligible_rebalance_day s)) (eligible_rebalance_day d) (immediately_following_eligible_rebalance_day_after d s))))) :named PROBE_N26__rebalance_day_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
