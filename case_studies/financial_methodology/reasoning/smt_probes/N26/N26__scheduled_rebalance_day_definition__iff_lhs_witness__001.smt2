...
; Probe N26__scheduled_rebalance_day_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day)) (scheduled_rebalance_day d)) :named PROBE_N26__scheduled_rebalance_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
