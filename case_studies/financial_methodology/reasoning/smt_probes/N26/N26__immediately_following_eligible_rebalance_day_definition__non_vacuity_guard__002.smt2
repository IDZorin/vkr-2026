...
; Probe N26__immediately_following_eligible_rebalance_day_definition__non_vacuity_guard__002: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s Day) (e Day)) (and (strictly_before s e) (strictly_before e d))) :named PROBE_N26__immediately_following_eligible_rebalance_day_definition__non_vacuity_guard__002))
(check-sat)
(pop 1)
