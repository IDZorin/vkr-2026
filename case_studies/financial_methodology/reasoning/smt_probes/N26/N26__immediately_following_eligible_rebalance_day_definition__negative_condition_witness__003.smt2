...
; Probe N26__immediately_following_eligible_rebalance_day_definition__negative_condition_witness__003: negative_condition_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s Day) (e Day)) (not (eligible_rebalance_day e))) :named PROBE_N26__immediately_following_eligible_rebalance_day_definition__negative_condition_witness__003))
(check-sat)
(pop 1)
