...
; Probe N26__immediately_following_eligible_rebalance_day_definition__non_vacuity_guard__001: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s Day)) (immediately_following_eligible_rebalance_day_after d s)) :named PROBE_N26__immediately_following_eligible_rebalance_day_definition__non_vacuity_guard__001))
(check-sat)
(pop 1)
