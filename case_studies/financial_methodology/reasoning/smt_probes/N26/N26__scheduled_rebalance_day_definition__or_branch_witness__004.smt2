...
; Probe N26__scheduled_rebalance_day_definition__or_branch_witness__004: or_branch_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day)) (nth_wednesday_in_month d November FirstWeekdayOrdinal)) :named PROBE_N26__scheduled_rebalance_day_definition__or_branch_witness__004))
(check-sat)
(pop 1)
