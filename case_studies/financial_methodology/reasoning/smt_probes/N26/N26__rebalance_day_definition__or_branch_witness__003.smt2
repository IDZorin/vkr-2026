...
; Probe N26__rebalance_day_definition__or_branch_witness__003: or_branch_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day)) (and (scheduled_rebalance_day d) (eligible_rebalance_day d))) :named PROBE_N26__rebalance_day_definition__or_branch_witness__003))
(check-sat)
(pop 1)
