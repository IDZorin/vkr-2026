...
; Probe N26__rebalance_day_definition__negative_condition_witness__006: negative_condition_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day) (s Day)) (not (eligible_rebalance_day s))) :named PROBE_N26__rebalance_day_definition__negative_condition_witness__006))
(check-sat)
(pop 1)
