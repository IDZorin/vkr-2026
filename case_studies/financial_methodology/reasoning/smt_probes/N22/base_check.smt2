...
(assert (! (term_shall_have_meaning_defined_in_section IndexUniverseRequirementsTerm Section2_1) :named TEXT_index_universe_requirements_meaning_defined_in_section_2_1))
(check-sat)
