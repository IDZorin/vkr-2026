...
(assert (! (term_shall_have_meaning_defined_in_section BenchmarkRegulationTerm IntroductionSection) :named TEXT_benchmark_regulation_meaning_defined_in_introduction))
(check-sat)
