...
; Probe section_5_1__index_determination_discretion_scope__existential_witness__001: existential_witness
(check-sat)
(push 1)
(assert (! (exists ((d Discretion)) (and (IndexDeterminationDiscretion d) (exists ((m IndexDeterminationMatter)) (discretion_in_relation_to_matter d m)))) :named PROBE_section_5_1__index_determination_discretion_scope__existential_witness__001))
(check-sat)
(pop 1)
