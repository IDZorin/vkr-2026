...
; Probe N09__eligible_rebalance_day_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((d Day)) (and (EligibleRebalanceDay d) (eligible_rebalance_day d))) :named PROBE_N09__eligible_rebalance_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
