...
; Probe section_4_3__index_level_rounded_to_two_decimal_places__non_vacuity_guard__001: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((l Real)) (and (IndexLevel l) (level_of_index l TheIndex))) :named PROBE_section_4_3__index_level_rounded_to_two_decimal_places__non_vacuity_guard__001))
(check-sat)
(pop 1)
