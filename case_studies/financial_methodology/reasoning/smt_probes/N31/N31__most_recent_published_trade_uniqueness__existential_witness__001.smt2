...
; Probe N31__most_recent_published_trade_uniqueness__existential_witness__001: existential_witness
(check-sat)
(push 1)
(assert (! (exists ((t1 Trade) (t2 Trade)) (exists ((c FinancialInstrument)) (and (IndexComponent c) (exists ((d Day)) (and (TradingDay d) (=> (and (trade_component t1 c) (trade_component t2 c) (trade_day t1 d) (trade_day t2 d) (trade_exchange t1 (respective_exchange c)) (trade_exchange t2 (respective_exchange c))) (= t1 t2))))))) :named PROBE_N31__most_recent_published_trade_uniqueness__existential_witness__001))
(check-sat)
(pop 1)
