...
; Probe N31__most_recent_published_trade_temporal_ordering__non_vacuity_guard__003: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((t Trade) (other Trade) (c FinancialInstrument) (d Day)) (and (IndexComponent c) (TradingDay d) (and (trade_component t c) (trade_component other c) (trade_day t d) (trade_day other d) (trade_exchange t (respective_exchange c)) (trade_exchange other (respective_exchange c))))) :named PROBE_N31__most_recent_published_trade_temporal_ordering__non_vacuity_guard__003))
(check-sat)
(pop 1)
