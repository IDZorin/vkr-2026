...
; Probe N31__most_recent_published_trade_uniqueness__non_vacuity_guard__003: non_vacuity_guard
(check-sat)
(push 1)
(assert (! (exists ((t1 Trade) (t2 Trade) (c FinancialInstrument) (d Day)) (and (IndexComponent c) (TradingDay d) (and (trade_component t1 c) (trade_component t2 c) (trade_day t1 d) (trade_day t2 d) (trade_exchange t1 (respective_exchange c)) (trade_exchange t2 (respective_exchange c))))) :named PROBE_N31__most_recent_published_trade_uniqueness__non_vacuity_guard__003))
(check-sat)
(pop 1)
