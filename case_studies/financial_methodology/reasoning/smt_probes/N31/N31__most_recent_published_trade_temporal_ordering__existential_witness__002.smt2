...
; Probe N31__most_recent_published_trade_temporal_ordering__existential_witness__002: existential_witness
(check-sat)
(push 1)
(assert (! (exists ((t Trade) (other Trade) (c FinancialInstrument)) (and (IndexComponent c) (exists ((d Day)) (and (TradingDay d) (=> (and (trade_component t c) (trade_component other c) (trade_day t d) (trade_day other d) (trade_exchange t (respective_exchange c)) (trade_exchange other (respective_exchange c))) (>= (trade_time t) (trade_time other))))))) :named PROBE_N31__most_recent_published_trade_temporal_ordering__existential_witness__002))
(check-sat)
(pop 1)
