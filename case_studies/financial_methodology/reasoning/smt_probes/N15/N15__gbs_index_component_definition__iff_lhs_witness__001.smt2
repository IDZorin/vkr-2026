...
; Probe N15__gbs_index_component_definition__iff_lhs_witness__001: iff_lhs_witness
(check-sat)
(push 1)
(assert (! (exists ((s FinancialInstrument)) (and (Security s) (gbs_index_component s GbsIndexSpecifiedInSection2_1))) :named PROBE_N15__gbs_index_component_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
