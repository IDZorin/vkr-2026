...
(check-sat)
(push 1)
(assert (! (and (IndexLevel W_l_IndexLevel) (level_of_index W_l_IndexLevel TheIndex)) :named BOUNDED_PROBE_section_4_3__index_level_rounded_to_two_decimal_places__non_vacuity_guard__001))
(check-sat)
(pop 1)
