...
(check-sat)
(push 1)
(assert (! (and (IndexComponent W_c_IndexComponent) (TradingDay W_d_TradingDay) (not (closing_price_available W_c_IndexComponent W_d_TradingDay))) :named BOUNDED_PROBE_N07__last_trading_price_used_when_closing_price_not_published__non_vacuity_guard__001))
(check-sat)
(pop 1)
