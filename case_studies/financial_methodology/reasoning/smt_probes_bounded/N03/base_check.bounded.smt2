...
(declare-const BMRTerm DefinedTerm)
...
(assert (! (term_shall_have_meaning_defined_in_section BMRTerm IntroductionSection) :named BOUNDED_TEXT_bmr_meaning_defined_in_introduction))
(check-sat)
