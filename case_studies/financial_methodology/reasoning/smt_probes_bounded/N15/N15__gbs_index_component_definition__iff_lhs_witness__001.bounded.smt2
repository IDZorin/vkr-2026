...
(check-sat)
(push 1)
(assert (! (and (Security W_s_Security) (gbs_index_component W_s_Security GbsIndexSpecifiedInSection2_1)) :named BOUNDED_PROBE_N15__gbs_index_component_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
