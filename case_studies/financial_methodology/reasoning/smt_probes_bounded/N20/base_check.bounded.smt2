...
(assert (! (term_shall_have_meaning_defined_in_section IndexComponentRequirementsTerm Section2_2) :named BOUNDED_TEXT_index_component_requirements_meaning_defined_in_section_2_2))
(check-sat)
