...
(check-sat)
(push 1)
(assert (! (and (RebalanceDay W_d_RebalanceDay) (ScheduledRebalanceDay W_s_ScheduledRebalanceDay) (not (eligible_rebalance_day W_s_ScheduledRebalanceDay))) :named BOUNDED_PROBE_N26__rebalance_day_definition__negative_condition_witness__007))
(check-sat)
(pop 1)
