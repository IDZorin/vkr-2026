...
(check-sat)
(push 1)
(assert (! (and (RebalanceDay W_d_RebalanceDay) (and (ScheduledRebalanceDay W_s_ScheduledRebalanceDay) (and (= W_d_RebalanceDay W_s_ScheduledRebalanceDay) (scheduled_rebalance_day W_s_ScheduledRebalanceDay) (eligible_rebalance_day W_s_ScheduledRebalanceDay)))) :named BOUNDED_PROBE_N26__rebalance_day_definition__existential_witness__004))
(check-sat)
(pop 1)
