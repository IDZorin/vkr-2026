...
(check-sat)
(push 1)
(assert (! (and (ScheduledRebalanceDay W_d_ScheduledRebalanceDay) (scheduled_rebalance_day W_d_ScheduledRebalanceDay)) :named BOUNDED_PROBE_N26__scheduled_rebalance_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
