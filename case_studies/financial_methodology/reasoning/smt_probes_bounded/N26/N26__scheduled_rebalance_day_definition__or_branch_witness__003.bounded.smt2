...
(check-sat)
(push 1)
(assert (! (and (ScheduledRebalanceDay W_d_ScheduledRebalanceDay) (nth_wednesday_in_month W_d_ScheduledRebalanceDay May FirstWeekdayOrdinal)) :named BOUNDED_PROBE_N26__scheduled_rebalance_day_definition__or_branch_witness__003))
(check-sat)
(pop 1)
