...
(check-sat)
(push 1)
(assert (! (and (ScheduledRebalanceDay W_d_ScheduledRebalanceDay) (or (nth_wednesday_in_month W_d_ScheduledRebalanceDay May FirstWeekdayOrdinal) (nth_wednesday_in_month W_d_ScheduledRebalanceDay November FirstWeekdayOrdinal))) :named BOUNDED_PROBE_N26__scheduled_rebalance_day_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
