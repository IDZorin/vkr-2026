...
(assert (! (term_shall_have_meaning_defined_in_section IndexAdministratorTerm IntroductionSection) :named BOUNDED_TEXT_index_administrator_meaning_defined_in_introduction))
(check-sat)
