...
(check-sat)
(push 1)
(assert (! (and (SelectionDay W_d_SelectionDay) (Security W_s_Security) (sourced_from_data_vendor (shares_outstanding_in_free_float W_d_SelectionDay (share_class W_d_SelectionDay W_s_Security)) W_vendor_DataVendor)) :named BOUNDED_PROBE_N13__free_float_market_capitalization_calculated_as_multiplication_definition__existential_witness__002))
(check-sat)
(pop 1)
