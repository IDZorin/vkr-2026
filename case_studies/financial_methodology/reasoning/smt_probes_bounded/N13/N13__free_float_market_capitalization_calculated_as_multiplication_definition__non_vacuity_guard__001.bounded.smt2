...
(check-sat)
(push 1)
(assert (! (and (SelectionDay W_d_SelectionDay) (Security W_s_Security) (fulfills_index_component_requirements W_d_SelectionDay W_s_Security)) :named BOUNDED_PROBE_N13__free_float_market_capitalization_calculated_as_multiplication_definition__non_vacuity_guard__001))
(check-sat)
(pop 1)
