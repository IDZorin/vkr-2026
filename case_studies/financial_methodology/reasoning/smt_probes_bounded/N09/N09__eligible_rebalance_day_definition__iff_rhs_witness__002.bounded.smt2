...
(check-sat)
(push 1)
(assert (! (and (EligibleRebalanceDay W_d_EligibleRebalanceDay) (and (trading_day_at_exchange W_d_EligibleRebalanceDay NewYorkStockExchange) (trading_day_at_exchange W_d_EligibleRebalanceDay LondonStockExchange) (trading_day_at_exchange W_d_EligibleRebalanceDay EUREXExchange) (trading_day_at_exchange W_d_EligibleRebalanceDay TokyoStockExchange))) :named BOUNDED_PROBE_N09__eligible_rebalance_day_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
