...
(check-sat)
(push 1)
(assert (! (and (EligibleRebalanceDay W_d_EligibleRebalanceDay) (eligible_rebalance_day W_d_EligibleRebalanceDay)) :named BOUNDED_PROBE_N09__eligible_rebalance_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
