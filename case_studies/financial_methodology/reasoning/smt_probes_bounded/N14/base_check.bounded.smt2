...
(assert (! (and (index_universe_as_defined_in_guideline TheGbsIndexUniverse SolactiveGBSBenchmarkSeriesGuideline) (index_universe_for_gbs_index TheGbsIndexUniverse GbsIndexSpecifiedInSection2_1)) :named BOUNDED_TEXT_gbs_index_universe_definition))
(check-sat)
