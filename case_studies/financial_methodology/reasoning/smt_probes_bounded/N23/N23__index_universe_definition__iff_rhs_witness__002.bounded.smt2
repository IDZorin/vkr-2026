...
(check-sat)
(push 1)
(assert (! (fulfills_index_universe_requirements W_fi_FinancialInstrument TheIndexUniverseRequirements) :named BOUNDED_PROBE_N23__index_universe_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
