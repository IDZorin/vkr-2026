...
(check-sat)
(push 1)
(assert (! (financial_instrument_in_index_universe W_fi_FinancialInstrument TheIndexUniverse) :named BOUNDED_PROBE_N23__index_universe_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
