...
(check-sat)
(push 1)
(assert (! (and (Security W_s_Security) (security_reflected_in_index W_s_Security TheIndex)) :named BOUNDED_PROBE_N19__index_component_definition__iff_rhs_witness__002))
(check-sat)
(pop 1)
