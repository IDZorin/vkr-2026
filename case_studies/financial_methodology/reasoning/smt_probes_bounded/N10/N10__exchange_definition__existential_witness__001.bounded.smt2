...
(check-sat)
(push 1)
(assert (! (and (IndexComponent W_c_IndexComponent) (and (listing_component W_l_Listing W_c_IndexComponent) (listing_determined_in_accordance_with_rules W_l_Listing Section2Rules) (= (respective_exchange_for_index_component TheIndex W_c_IndexComponent) (listing_exchange W_l_Listing)))) :named BOUNDED_PROBE_N10__exchange_definition__existential_witness__001))
(check-sat)
(pop 1)
