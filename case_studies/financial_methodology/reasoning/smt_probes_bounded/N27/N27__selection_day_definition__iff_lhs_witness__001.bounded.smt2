...
(check-sat)
(push 1)
(assert (! (and (SelectionDay W_sd_SelectionDay) (RebalanceDay W_rd_RebalanceDay) (selection_day_for_rebalance_day W_sd_SelectionDay W_rd_RebalanceDay)) :named BOUNDED_PROBE_N27__selection_day_definition__iff_lhs_witness__001))
(check-sat)
(pop 1)
