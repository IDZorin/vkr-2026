...
(check-sat)
(push 1)
(assert (! (and (ExtraordinaryRebalance W_r_ExtraordinaryRebalance) (not (rebalance_of_index W_r_ExtraordinaryRebalance TheIndex))) :named BOUNDED_PROBE_section_3_2__index_not_rebalanced_extraordinarily__negative_condition_witness__001))
(check-sat)
(pop 1)
